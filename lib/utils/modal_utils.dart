                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () async => showModal(context, CreateAllergy(medications: await FirestoreService.getMedications(), allergyToEdit: allergy)),
                          child: Text('Edit', style: TextStyle(color: Theme.of(context).colorScheme.surfaceContainerLow)),
                        ),
                      ],
                    ),
                    Text(
